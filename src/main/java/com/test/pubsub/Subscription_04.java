...
public class Subscription_04 {
	...
	public static void main(String... args) throws Exception {
		System.out.print("Sus A");
		subscriptionA();
		System.out.print("Sus B");
		subscriptionB();
	}

	public static void subscriptionA() {
		// set subscriber id, eg. my-sub
		String subscriptionId = "my-sub-a";
		...
		try {
			...
			// Allow the subscriber to run indefinitely unless an unrecoverable error
			// occurs.
	...
	public static void subscriptionB() {
		// set subscriber id, eg. my-sub
		String subscriptionId = "my-sub-b";
		ProjectSubscriptionName subscriptionName = ProjectSubscriptionName.of(PROJECT_ID, subscriptionId);
		Subscriber subscriber = null;
		try {
			// create a subscriber bound to the asynchronous message receiver
